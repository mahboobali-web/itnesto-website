    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between h-[70px]">
        ...
        <a href="/" className="flex items-center gap-2 group">
          <div className="w-8 h-8 rounded-lg bg-[#2F54EB] flex items-center justify-center text-white font-bold text-sm transition-transform group-hover:scale-110">
            IT
          </div>
        ...
        <div className="hidden md:flex items-center gap-3">
          <a
            ...
            className="text-sm text-[#8BA3E0] hover:text-white transition-colors"
          >
            hello@itnesto.com
          </a>
          <a
